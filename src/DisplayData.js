...
class DisplyData extends Component{
	...
	render(){
		return(
       <div>
               <div className="container display-box" onClick={this.props.goTo(1)}>
          ...
          <div className="container display-box" onClick={this.props.goTo(2)}>
          ...
          <p>{edu.marks}</p>
           ...
           <div className="container display-box" onClick={this.props.goTo(3)}>
